...
import type { ITagsService } from "@/service/infrastructure/tagService.js";
...
import { supportsUptimeDetails } from "@/types/monitor.js";
...
const callTool = async (name: string, args: Record<string, unknown>, teamId: string, svc: McpServices) => {
	...
	if (name === "list_incidents") {
		const dateRange = typeof args.date_range === "string" ? args.date_range : "week";
